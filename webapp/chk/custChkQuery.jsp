...
<head>
	...
	function viewChkRecords(){
		...
		top.addTab("客户检测记录", "<%=request.getContextPath()%>/chk/checkData_custCheckDetail.action?custId=" + selected.userId);
	}
</script>
</head>
<body>
		...
		<table>
			<tr>
				<td style="padding-left: 2px;">
					<a href="javascript:viewChkRecords();" class="easyui-linkbutton">查看检测记录</a>
				</td>
			</tr>
		</table>
	</div>
