...
<div style="padding:5px;margin-left: 150px;">
 ...
 <tr><td colspan="4" align="left" class="table_title">转诊情况</td></tr>
  ...
  <tr>
    ...
    <td colspan="3">
    	<fmt:formatDate value="${info.nextFlupTime}" pattern="yyyy-MM-dd"/>
    	<%-- <input name="nextFlupTimeStr" class="Wdate" value="${info.nextFlupTime}" onClick="WdatePicker({minDate:'%y-%M-%d'})" style="height:25px;width:150px"/> --%></td>
  </tr>
  <c:if test="${fn:contains(manInfo.roles, '21')}">
  <tr>
  	<td colspan="4" align="center"><a href="javascript:doFormValid();" id="msubmitbtn" class="easyui-linkbutton">提交</a>
		<a href="#" id="mviewbtn" class="easyui-linkbutton"   onclick="viewOrAdd(true);">编辑</a></td>
  </tr>
  </c:if>
</table>
