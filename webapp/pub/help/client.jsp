	...
	<div class="warp">
		...
		<div class="secWarp">
			<div class="qWarp">
				...
				<div class="qAnswer">
					进入我的检测记录界面，选择想要查看的体征项，弹出记录列表栏后对列表栏进行下拉即可同步服务器端测量数据，并显示在检测记录列表中。</div>
			</div>
		</div>
		...
		<div class="secWarp">
			<div class="qWarp">
				...
				<div class="qAnswer">
					在首页选择更多选项，进入家庭成员项，点击右上角添加，输入家人用户名或手机号即可发送添加申请，等待同意后即添加成功。</div>
			</div>
			<div class="qWarp">
				<div class="qTitle">2) 如何查看家庭成员检测记录</div>
				<div class="qAnswer">进入家庭成员选项，可以看到家庭成员列表，点击列表中某位家人，即可查看他的检测记录。</div>
			</div>
		</div>
		...
		<div class="secWarp">
			<div class="qWarp">
				...
				<div class="qAnswer">
					由于需要数据累计到一定量方便趋势的查看，健康管家设置每周生成一份健康报告，生成时间为每周星期一凌晨生成上一周健康报告。</div>
			</div>
		</div>
