...
_27f.mask.css({width:(opts.inline?_27f.mask.parent().width():_283().width-2),height:(opts.inline?_27f.mask.parent().height():_283().height-2),display:"none"});
}
if(_27f.shadow){
_27f.shadow.remove();
}
...
$("body>div.window-mask").css({width:$(window)._outerWidth()-2,height:$(window)._outerHeight()-2});
setTimeout(function(){
$("body>div.window-mask").css({width:_283().width-2,height:_283().height-2});
},50);
});
