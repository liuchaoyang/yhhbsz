...
<head>
	...
	function prescription(){
		...
		//debugger;
		var custId = row.userId;
		var doctorId = row.doctorId;
		var userName = row.name;
		var src = '<%=request.getContextPath()%>/his/dzcf_toAdd.action?custId=' + custId + '&doctorId=' + doctorId + '&userName='+ userName;
		subWin1 = $('<div><iframe src="'+src+'" style="width: 99%;height: 99%;" border="0" frameborder="0"></iframe></div>').window({
			title: "开处方",
			width: 700,
			height: 500,
			resizable: false,
