...
<html>
	<head>
		...
		function check(){
			...
			subWin2 = $('<div><iframe src="<%=request.getContextPath()%>/his/appoint_toCheck.action?operType=detail&id=' + selected.id + '" style="width: 99%;height: 99%;" border="0" frameborder="0"></iframe></div>').window({
				title: "查看预约",
				width: 650,
				height: 450,
				resizable: false,
	...
	<div>
		<form id="filterForm">
			<table class="table">
				...
				<tr>
					<td width="15%" class="td_title">预约日期:</td>
		...
		<table>
			<tr>
				<td style="padding-left: 2px;">
					<a href="javascript:check();" class="easyui-linkbutton">查看</a>
				</td>
			</tr>
		</table>
	</div>
